...
var config = {
  ...
  module: {
    noParse: ['react-router', 'redux-router', 'fixed-data-table', 'react-widgets', 'react-input-switch'],
    ...
    loaders: [{
      ...
      include: [
        ...
        Path.resolve("./node_modules/fixed-data-table"),
        Path.resolve("./node_modules/react-input-switch"),
      ],
      loader: "style!css"
    },
    {
      test: /\.css$/,
      exclude: [/react-/, /bootstrap/, /formsy-react/, /fixed-data-table/],
